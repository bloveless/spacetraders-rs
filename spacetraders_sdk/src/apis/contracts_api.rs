...
pub struct AcceptContractParams {
    pub contract_id: String
}

/// struct for passing parameters to the method [`deliver_contract`]
#[derive(Clone, Debug, Default)]
pub struct DeliverContractParams {
    /// The ID of the contract
    pub contract_id: String,
    pub deliver_contract_request: Option<crate::models::DeliverContractRequest>
}

/// struct for passing parameters to the method [`fulfill_contract`]
#[derive(Clone, Debug, Default)]
pub struct FulfillContractParams {
    /// The ID of the contract
    pub contract_id: String
}
...
/// struct for passing parameters to the method [`get_contracts`]
#[derive(Clone, Debug, Default)]
...
pub async fn accept_contract(configuration: &configuration::Configuration, params: AcceptContractParams) -> Result<crate::models::AcceptContract200Response, Error<AcceptContractError>> {
    ...
    if reqwest::Method::POST == reqwest::Method::POST {
...
pub async fn deliver_contract(configuration: &configuration::Configuration, params: DeliverContractParams) -> Result<crate::models::DeliverContract200Response, Error<DeliverContractError>> {
    ...
    // unbox the parameters
    let contract_id = params.contract_id;
    let deliver_contract_request = params.deliver_contract_request;
