...
pub struct GetFactionParams {
    /// The faction symbol
    pub faction_symbol: String
}

/// struct for passing parameters to the method [`get_factions`]
#[derive(Clone, Debug, Default)]
pub struct GetFactionsParams {
...
pub async fn get_faction(configuration: &configuration::Configuration, params: GetFactionParams) -> Result<crate::models::GetFaction200Response, Error<GetFactionError>> {
    ...
    let faction_symbol = params.faction_symbol;
